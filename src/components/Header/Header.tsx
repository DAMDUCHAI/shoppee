        ...
        <nav className='header__navbar hide-on-mobile-tablet'>
          <ul className='header__navbar-list'>
            <li className='header__navbar-item'>
              <a href='https://banhang.shopee.vn/' className='header__navbar-item-link header__navbar-item--separate'>
                Kênh người bán
              </a>
            </li>
            <li className='header__navbar-item'>
            ...
            <li className='header__navbar-item header__navbar-item--has-qr header__navbar-item--separate'>
              ...
              <div className='header__qr'>
                <img className='header__qr-img' src='./assets/img/qr_code.png' alt='QR code' />
                <div className='header__qr-apps'>
                  <a href='' className='header__qr-link'>
                    <img src='./assets/img/googleplay.png' alt='Google Play' className='header__qr-download-img' />
                  </a>
                  <a href='' className='header__qr-link'>
                    <img src='./assets/img/appstore.png' alt='Appstore' className='header__qr-download-img' />
                  </a>
                </div>
              </div>
            </li>
            <li className='header__navbar-item'>
              ...
              <a href='https://www.facebook.com/khoahd7621/' className='header__navbar-icon-link'>
                <i className='header__navbar-icon fa-brands fa-facebook'></i>
              </a>
              <a href='https://www.instagram.com/khoahd7621/' className='header__navbar-icon-link'>
          ...
          <ul className='header__navbar-list'>
                ...
                <ul className='header__notify-list'>
                  ...
                  <li className='header__notify-item'>
                    <a href='' className='header__notify-link'>
                      ...
                      <div className='header__notify-info'>
                        ...
                        <span className='header__notify-description'>Siêu sale duy nhất 3 ngày 11 - 13/12/2022</span>
                      </div>
                    </a>
                  </li>
                  <li className='header__notify-item'>
                    <a href='' className='header__notify-link'>
                      <img
                        src='http://d20aeo683mqd6t.cloudfront.net/vi/articles/title_images/000/040/760/medium/Hadalabo-5822.jpg?2021'
                        alt=''
                        className='header__notify-img'
                      />
                      <div className='header__notify-info'>
                        <span className='header__notify-name'>DA NHẠY CẢM THÌ CÓ DÙNG ĐƯỢC SECRET KHÔNG?</span>
                        <span className='header__notify-description'>
                  ...
                  <li className='header__notify-item'>
                    <a href='' className='header__notify-link'>
                      ...
                      />
                      <div className='header__notify-info'>
                        <span className='header__notify-name'>BỘ SƯU TẬP PHIÊN BẢN GIỚI HẠN MÙA LỆ HỘI 2021</span>
                        <span className='header__notify-description'>
            ...
            <li className='header__navbar-item'>
              <a href='https://help.shopee.vn/vn/s' className='header__navbar-item-link'>
                <i className='header__navbar-icon far fa-circle-question'></i>
                Hỗ trợ
              </a>
            </li>
          ...
          <div className='header__cart'>
            <div className='header__cart-wrap'>
              ...
              <div className='header__cart-list'>
                <img src='./assets/img/no_cart.png' alt='No cart' className='header__cart-no-cart-img' />
                ...
                <ul className='header__cart-list-item'>
                  <li className='header__cart-item'>
                    <img
                      src='https://runningwithmiles.boardingarea.com/wp-content/uploads/2015/02/Screen-Shot-2015-02-26-at-3.57.06-PM.png'
                      alt=''
                      className='header__cart-img'
                    />
                    <div className='header__cart-item-info'>
                      <div className='header__cart-item-head'>
                        <h5 className='header__cart-item-name'>Máy ảnh samsung DSLR 3D</h5>
                  ...
                  <li className='header__cart-item'>
                    <img
                      src='http://scontent.webpluscnd.net/photos-df/a-0/3764-2194538-1/laptop-asus-gaming-rog-strix-g-g731gth7114t.png?atk=4eb081075dd7d7faad048034c002a610'
                      alt=''
                      className='header__cart-img'
                    />
                    <div className='header__cart-item-info'>
                      <div className='header__cart-item-head'>
                        <h5 className='header__cart-item-name'>Laptop Asus Gaming ROG Strix</h5>
                        <div className='divheader__cart-item-price-wrap'>
                          <span className='header__cart-item-price'>29.000.000đ</span>
                          <span className='header__cart-item-multiply'>x</span>
                          <span className='header__cart-item-qnt'>1</span>
                        </div>
                      </div>
                      <div className='header__cart-item-body'>
                        <span className='header__cart-item-description'>Phân loại: Laptop Gaming</span>
                        <span className='header__cart-item-remove'>Xóa</span>
                      </div>
                    </div>
                  </li>
